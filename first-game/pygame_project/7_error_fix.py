...
stage_hight = stage_size[1] # 스테이지의 높이 위에 캐릭터를 두기 위해
...
character_y_pos = (screen_height - character_height - stage_hight)
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        break # 안쪽 for문에서 break 를 만나면 여기로 진입 가능, 2중 for 문을 한번에 탈출
